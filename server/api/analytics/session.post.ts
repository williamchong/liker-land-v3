...
export default defineEventHandler(async (event) => {
  ...
  const hasPacedDelta = paced.activeReadingTimeMsDelta > 0 || paced.ttsActiveTimeMsDelta > 0
  ...
  try {
    publishEvent(event, 'ReadingSession', {
      ...
      activeReadingTimeMs,
      ttsActiveTimeMs,
      activeReadingTimeMsPaced: paced.activeReadingTimeMsDelta,
      ttsActiveTimeMsPaced: paced.ttsActiveTimeMsDelta,
      pagesViewed,
      startProgress,
      endProgress,
      readerType,
